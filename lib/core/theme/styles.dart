...
class TextStyles {
  /// start white custom text styles
  ...
  static TextStyle font24RedBlod = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.raRed,
  );
  static TextStyle font24GreenBlod = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.raGreenDark,
  );

  static TextStyle font24GrayBlod = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeightHelper.bold,
  ...
  static TextStyle font20RaBrown = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.raBrown,
  );

  static TextStyle font20GrayDark = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.grayDark,
  );

  static TextStyle font20RaGreenDark = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.raGreenDark,
  );
  static TextStyle font20RaDarkYellow = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.raDarkYellow,
  );
  ...
  static TextStyle fontOnBoardingWhiteMedium = TextStyle(
    fontSize: 19.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.raWhite,
  );

  /// End white custom text styles
  ...
  static TextStyle font23BlackMedium = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.raBlack,
  );

  static TextStyle font23BlackLight = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.light,
    color: ColorsManager.raBlack,
  );
  ...
  static TextStyle font15DarkGrayTextField = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.raDarkGray2,
  );
